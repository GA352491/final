...
urlpatterns = [
    ...
    path('g_bill/', views.general_bill, name='g_bill'),
    path('test/', views.test, name='test'),
    path('test_stock/', views.test_stock, name='test_stock'),
    path('test_customer/', views.test_customer_list, name='test_cus_list'),
    path('test_cus_view/<str:pk>', views.test_customer, name='test_cus_view'),
